...
namespace SimsTcpClient
{
    ...
    public delegate void UpdateInfoEvent(int numDlls);
    public delegate void StartGamePlayEvent();
    public delegate void GameMessageEvent(byte[] messages);
    ...
    public partial class TcpCommunication
    {
        ...
        public UpdateInfoEvent OnUpdateInfoReceived = null;
        public WorldInfoEvent OnWorldInfoReceived = null;
        public LaunchGameEvent OnLaunchGame = null;
        public StartGamePlayEvent OnStartGamePlay = null;
        public GameMessageEvent OnGameMessage = null;
        //////////////////////////////////Network
